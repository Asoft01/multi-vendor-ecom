                    ...
                    <div class="reg-wrapper">
                        ...
                        <form id="userForm" action="{{ url('/user/register') }}" method="post">@csrf
                            <div class="u-s-m-b-30">
                                ...
                                <input type="text" id="username" name="name" class="text-field" placeholder="User Name">
                            </div>
                            <div class="u-s-m-b-30">
                                <label for="usermobile">Mobile
                                    <span class="astk">*</span>
                                </label>
                                <input type="text" id="usermobile" name="mobile" class="text-field" placeholder="User Mobile">
                            </div>
                            <div class="u-s-m-b-30">
                                <label for="useremail">Email
                                    <span class="astk">*</span>
                                </label>
                                <input type="email" id="useremail" name="email" class="text-field" placeholder="User Email">
                            </div>
                            <div class="u-s-m-b-30">
